    ...
    <>
      ...
      {account.status === "approved" && (
        ...
        >
          <Item
            title="Share Capital"
            to={`/member/share-capital/${account.id}`}
            icon={<ReceiptOutlinedIcon />}
            selected={selected}
            setSelected={setSelected}
          />
      ...
      {account.status === "approved" && (
        <Item
          ...
          to={`/member/loan-application/${account.id}`}
...
const LoanOfficerNav = ({ selected, setSelected }) => {
  ...
  return (
    <>
      ...
      <Item
        title="New Loans"
        to="/loan-officer/new-loans"
        icon={<PersonOutlinedIcon />}
        selected={selected}
        setSelected={setSelected}
      />
      <Item
        title="Updates of Loans"
        to="/loan-officer/updates-loans"
      ...
      <Item
        ...
        to="/loan-officer/share-capital-payment"
        icon={<CalendarTodayOutlinedIcon />}
        selected={selected}
        setSelected={setSelected}
      />
