				...
				>
					...
					<Grid container columnSpacing={2.5} rowSpacing={2.5} pb="20px">
						<Grid item xs={12} lg={6}>
							<TextField name="first_name" label="First Name" defaultValue="" required fullWidth />
						</Grid>
						<Grid item xs={12} lg={6}>
							<TextField name="last_name" label="Last Name" defaultValue="" required fullWidth />
						</Grid>
						<Grid item xs={12} lg={6}>
							<TextField name="contact_number" label="Contact Number" defaultValue="" required fullWidth />
						</Grid>
						<Grid item xs={12} lg={6}>
							<FormControl fullWidth>
								<InputLabel id="department">Department</InputLabel>
								<Select labelId="department" name="department" defaultValue="cos" required label="Department">
									{deparments.map((d) => (
					...
					<Grid container columnSpacing={2.5} rowSpacing={2.5} pb="20px">
						<Grid item xs={12} lg={6}>
							<TextField name="email" type="email" label="Email" defaultValue="" required fullWidth />
						</Grid>
						<Grid item xs={12} lg={6}>
							<TextField name="password" type="password" label="Password" defaultValue="" required fullWidth />
						</Grid>
						<Grid item xs={12} lg={6}>
							<TextField
						...
						<Grid item xs={12} lg={6}>
							<TextField name="monthly_investment" type="number" label="Monthly Investment" defaultValue={100} fullWidth required />
						</Grid>
						<Grid item xs={12} lg={6}>
							<TextField name="pay_slip_file" type="file" helperText="Upload your current pay slip here" fullWidth required />
						</Grid>
					</Grid>
