	...
	return (
		<Box display="flex" flexDirection="column" height="100%">
			<Box display="flex" justifyContent="space-between">
				<Header title="CASH OUT" subtitle="This is the cash-out monthly deductions report" />
			...
			<Box display="flex" flexDirection="column" height="100%" justifyContent="space-between">
				<Grid container columnSpacing={2.5} rowSpacing={2.5} mb="20px">
					<StatPaper
						title={PHPPrice.format(result.reduce((i, data) => i.add(data.amount), new Decimal(0)).toString())}
